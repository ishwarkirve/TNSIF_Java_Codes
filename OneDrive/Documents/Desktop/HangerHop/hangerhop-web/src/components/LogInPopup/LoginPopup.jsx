    ...
    return (
        <div className='login_popup'>
            <form onSubmit={onLogin} className="login_popup_container">
                ...
                {currState === "Sign Up" ? <p>Already have account? <span onClick={() => { setCurrState("Login") }}>Login here</span></p> : <p>Create a new account? <span onClick={() => { setCurrState("Sign Up") }}>Click here</span></p>}
            </form>
        </div>
    )
}
